...
class DegradedReadRequest final :
 ...
 public:
  ...
  enum : int {
    ...
    kLeftoverBlockIdsFieldNumber = 15,
    kLocalFillSourceIdsFieldNumber = 16,
  ...
  int decode_block_ids_size() const;
  private:
  int _internal_decode_block_ids_size() const;
  public:
  void clear_decode_block_ids();
  private:
  int32_t _internal_decode_block_ids(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_decode_block_ids() const;
  void _internal_add_decode_block_ids(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_decode_block_ids();
  public:
  int32_t decode_block_ids(int index) const;
  void set_decode_block_ids(int index, int32_t value);
  void add_decode_block_ids(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      decode_block_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_decode_block_ids();
  ...
  int all_failed_block_ids_size() const;
  private:
  int _internal_all_failed_block_ids_size() const;
  public:
  void clear_all_failed_block_ids();
  private:
  int32_t _internal_all_failed_block_ids(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_all_failed_block_ids() const;
  void _internal_add_all_failed_block_ids(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_all_failed_block_ids();
  public:
  int32_t all_failed_block_ids(int index) const;
  void set_all_failed_block_ids(int index, int32_t value);
  void add_all_failed_block_ids(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      all_failed_block_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
  ...
  int local_fill_source_ids_size() const;
  private:
  int _internal_local_fill_source_ids_size() const;
  public:
  void clear_local_fill_source_ids();
  private:
  int32_t _internal_local_fill_source_ids(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_local_fill_source_ids() const;
  void _internal_add_local_fill_source_ids(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_local_fill_source_ids();
  public:
  int32_t local_fill_source_ids(int index) const;
  void set_local_fill_source_ids(int index, int32_t value);
  void add_local_fill_source_ids(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      local_fill_source_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_local_fill_source_ids();
  ...
  void clear_send_raw_union();
  bool send_raw_union() const;
  void set_send_raw_union(bool value);
  private:
  bool _internal_send_raw_union() const;
  void _internal_set_send_raw_union(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > blockids_;
    mutable std::atomic<int> _blockids_cached_byte_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > decode_block_ids_;
    mutable std::atomic<int> _decode_block_ids_cached_byte_size_;
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > local_fill_source_ids_;
    mutable std::atomic<int> _local_fill_source_ids_cached_byte_size_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr clientip_;
...
class RecoveryRequest final :
 ...
 public:
  ...
  enum : int {
    ...
    kDecodeBlockIdsFieldNumber = 14,
    kFailedBlockIdsFieldNumber = 15,
    kReplacedNodeIpsFieldNumber = 16,
    ...
    kLocalFillSourceIdsFieldNumber = 29,
    kLeftoverBlockKeysFieldNumber = 30,
    kLeftoverReplacedNodeIpsFieldNumber = 31,
    kLeftoverReplacedNodePortsFieldNumber = 32,
  ...
  int leftover_block_keys_size() const;
  private:
  int _internal_leftover_block_keys_size() const;
  public:
  void clear_leftover_block_keys();
  const std::string& leftover_block_keys(int index) const;
  std::string* mutable_leftover_block_keys(int index);
  void set_leftover_block_keys(int index, const std::string& value);
  void set_leftover_block_keys(int index, std::string&& value);
  void set_leftover_block_keys(int index, const char* value);
  void set_leftover_block_keys(int index, const char* value, size_t size);
  std::string* add_leftover_block_keys();
  void add_leftover_block_keys(const std::string& value);
  void add_leftover_block_keys(std::string&& value);
  void add_leftover_block_keys(const char* value);
  void add_leftover_block_keys(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& leftover_block_keys() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_leftover_block_keys();
  private:
  const std::string& _internal_leftover_block_keys(int index) const;
  std::string* _internal_add_leftover_block_keys();
  public:

  // repeated string leftover_replaced_node_ips = 31;
  int leftover_replaced_node_ips_size() const;
  private:
  int _internal_leftover_replaced_node_ips_size() const;
  public:
  void clear_leftover_replaced_node_ips();
  const std::string& leftover_replaced_node_ips(int index) const;
  std::string* mutable_leftover_replaced_node_ips(int index);
  void set_leftover_replaced_node_ips(int index, const std::string& value);
  void set_leftover_replaced_node_ips(int index, std::string&& value);
  void set_leftover_replaced_node_ips(int index, const char* value);
  void set_leftover_replaced_node_ips(int index, const char* value, size_t size);
  std::string* add_leftover_replaced_node_ips();
  void add_leftover_replaced_node_ips(const std::string& value);
  void add_leftover_replaced_node_ips(std::string&& value);
  void add_leftover_replaced_node_ips(const char* value);
  void add_leftover_replaced_node_ips(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& leftover_replaced_node_ips() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_leftover_replaced_node_ips();
  private:
  const std::string& _internal_leftover_replaced_node_ips(int index) const;
  std::string* _internal_add_leftover_replaced_node_ips();
  public:

  // repeated int32 leftover_replaced_node_ports = 32;
  int leftover_replaced_node_ports_size() const;
  private:
  int _internal_leftover_replaced_node_ports_size() const;
  public:
  void clear_leftover_replaced_node_ports();
  private:
  int32_t _internal_leftover_replaced_node_ports(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_leftover_replaced_node_ports() const;
  void _internal_add_leftover_replaced_node_ports(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_leftover_replaced_node_ports();
  public:
  int32_t leftover_replaced_node_ports(int index) const;
  void set_leftover_replaced_node_ports(int index, int32_t value);
  void add_leftover_replaced_node_ports(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      leftover_replaced_node_ports() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      mutable_leftover_replaced_node_ports();
  ...
  void clear_raw_sender_num();
  int32_t raw_sender_num() const;
  void set_raw_sender_num(int32_t value);
  private:
  int32_t _internal_raw_sender_num() const;
  void _internal_set_raw_sender_num(int32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > local_fill_source_ids_;
    mutable std::atomic<int> _local_fill_source_ids_cached_byte_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> leftover_block_keys_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> leftover_replaced_node_ips_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > leftover_replaced_node_ports_;
    mutable std::atomic<int> _leftover_replaced_node_ports_cached_byte_size_;
...
// repeated int32 decode_block_ids = 10;
inline int DegradedReadRequest::_internal_decode_block_ids_size() const {
  return _impl_.decode_block_ids_.size();
}
inline int DegradedReadRequest::decode_block_ids_size() const {
  return _internal_decode_block_ids_size();
}
inline void DegradedReadRequest::clear_decode_block_ids() {
  _impl_.decode_block_ids_.Clear();
}
inline int32_t DegradedReadRequest::_internal_decode_block_ids(int index) const {
  return _impl_.decode_block_ids_.Get(index);
}
inline int32_t DegradedReadRequest::decode_block_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.DegradedReadRequest.decode_block_ids)
  return _internal_decode_block_ids(index);
}
inline void DegradedReadRequest::set_decode_block_ids(int index, int32_t value) {
  _impl_.decode_block_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.DegradedReadRequest.decode_block_ids)
}
inline void DegradedReadRequest::_internal_add_decode_block_ids(int32_t value) {
  _impl_.decode_block_ids_.Add(value);
}
inline void DegradedReadRequest::add_decode_block_ids(int32_t value) {
  _internal_add_decode_block_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.DegradedReadRequest.decode_block_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::_internal_decode_block_ids() const {
  return _impl_.decode_block_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::decode_block_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.DegradedReadRequest.decode_block_ids)
  return _internal_decode_block_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::_internal_mutable_decode_block_ids() {
  return &_impl_.decode_block_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::mutable_decode_block_ids() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.DegradedReadRequest.decode_block_ids)
  return _internal_mutable_decode_block_ids();
}

// repeated int32 failed_block_ids = 11;
inline int DegradedReadRequest::_internal_failed_block_ids_size() const {
  return _impl_.failed_block_ids_.size();
}
inline int DegradedReadRequest::failed_block_ids_size() const {
  return _internal_failed_block_ids_size();
}
inline void DegradedReadRequest::clear_failed_block_ids() {
  _impl_.failed_block_ids_.Clear();
}
inline int32_t DegradedReadRequest::_internal_failed_block_ids(int index) const {
  return _impl_.failed_block_ids_.Get(index);
}
inline int32_t DegradedReadRequest::failed_block_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.DegradedReadRequest.failed_block_ids)
  return _internal_failed_block_ids(index);
}
inline void DegradedReadRequest::set_failed_block_ids(int index, int32_t value) {
  _impl_.failed_block_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.DegradedReadRequest.failed_block_ids)
}
inline void DegradedReadRequest::_internal_add_failed_block_ids(int32_t value) {
  _impl_.failed_block_ids_.Add(value);
}
inline void DegradedReadRequest::add_failed_block_ids(int32_t value) {
  _internal_add_failed_block_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.DegradedReadRequest.failed_block_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::_internal_failed_block_ids() const {
  return _impl_.failed_block_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::failed_block_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.DegradedReadRequest.failed_block_ids)
  return _internal_failed_block_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::_internal_mutable_failed_block_ids() {
  return &_impl_.failed_block_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::mutable_failed_block_ids() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.DegradedReadRequest.failed_block_ids)
  return _internal_mutable_failed_block_ids();
}

// repeated int32 all_failed_block_ids = 12;
inline int DegradedReadRequest::_internal_all_failed_block_ids_size() const {
  return _impl_.all_failed_block_ids_.size();
}
inline int DegradedReadRequest::all_failed_block_ids_size() const {
  return _internal_all_failed_block_ids_size();
}
inline void DegradedReadRequest::clear_all_failed_block_ids() {
  _impl_.all_failed_block_ids_.Clear();
}
inline int32_t DegradedReadRequest::_internal_all_failed_block_ids(int index) const {
  return _impl_.all_failed_block_ids_.Get(index);
}
inline int32_t DegradedReadRequest::all_failed_block_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.DegradedReadRequest.all_failed_block_ids)
  return _internal_all_failed_block_ids(index);
}
inline void DegradedReadRequest::set_all_failed_block_ids(int index, int32_t value) {
  _impl_.all_failed_block_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.DegradedReadRequest.all_failed_block_ids)
}
inline void DegradedReadRequest::_internal_add_all_failed_block_ids(int32_t value) {
  _impl_.all_failed_block_ids_.Add(value);
}
inline void DegradedReadRequest::add_all_failed_block_ids(int32_t value) {
  _internal_add_all_failed_block_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.DegradedReadRequest.all_failed_block_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::_internal_all_failed_block_ids() const {
  return _impl_.all_failed_block_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::all_failed_block_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.DegradedReadRequest.all_failed_block_ids)
  return _internal_all_failed_block_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::_internal_mutable_all_failed_block_ids() {
  return &_impl_.all_failed_block_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::mutable_all_failed_block_ids() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.DegradedReadRequest.all_failed_block_ids)
...
// repeated int32 leftover_block_ids = 15;
inline int DegradedReadRequest::_internal_leftover_block_ids_size() const {
  return _impl_.leftover_block_ids_.size();
}
inline int DegradedReadRequest::leftover_block_ids_size() const {
  return _internal_leftover_block_ids_size();
}
inline void DegradedReadRequest::clear_leftover_block_ids() {
  _impl_.leftover_block_ids_.Clear();
}
inline int32_t DegradedReadRequest::_internal_leftover_block_ids(int index) const {
  return _impl_.leftover_block_ids_.Get(index);
}
inline int32_t DegradedReadRequest::leftover_block_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.DegradedReadRequest.leftover_block_ids)
  return _internal_leftover_block_ids(index);
}
inline void DegradedReadRequest::set_leftover_block_ids(int index, int32_t value) {
  _impl_.leftover_block_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.DegradedReadRequest.leftover_block_ids)
}
inline void DegradedReadRequest::_internal_add_leftover_block_ids(int32_t value) {
  _impl_.leftover_block_ids_.Add(value);
}
inline void DegradedReadRequest::add_leftover_block_ids(int32_t value) {
  _internal_add_leftover_block_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.DegradedReadRequest.leftover_block_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::_internal_leftover_block_ids() const {
  return _impl_.leftover_block_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::leftover_block_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.DegradedReadRequest.leftover_block_ids)
  return _internal_leftover_block_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::_internal_mutable_leftover_block_ids() {
  return &_impl_.leftover_block_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::mutable_leftover_block_ids() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.DegradedReadRequest.leftover_block_ids)
  return _internal_mutable_leftover_block_ids();
}

// repeated int32 local_fill_source_ids = 16;
inline int DegradedReadRequest::_internal_local_fill_source_ids_size() const {
  return _impl_.local_fill_source_ids_.size();
}
inline int DegradedReadRequest::local_fill_source_ids_size() const {
  return _internal_local_fill_source_ids_size();
}
inline void DegradedReadRequest::clear_local_fill_source_ids() {
  _impl_.local_fill_source_ids_.Clear();
}
inline int32_t DegradedReadRequest::_internal_local_fill_source_ids(int index) const {
  return _impl_.local_fill_source_ids_.Get(index);
}
inline int32_t DegradedReadRequest::local_fill_source_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.DegradedReadRequest.local_fill_source_ids)
  return _internal_local_fill_source_ids(index);
}
inline void DegradedReadRequest::set_local_fill_source_ids(int index, int32_t value) {
  _impl_.local_fill_source_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.DegradedReadRequest.local_fill_source_ids)
}
inline void DegradedReadRequest::_internal_add_local_fill_source_ids(int32_t value) {
  _impl_.local_fill_source_ids_.Add(value);
}
inline void DegradedReadRequest::add_local_fill_source_ids(int32_t value) {
  _internal_add_local_fill_source_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.DegradedReadRequest.local_fill_source_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::_internal_local_fill_source_ids() const {
  return _impl_.local_fill_source_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
DegradedReadRequest::local_fill_source_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.DegradedReadRequest.local_fill_source_ids)
  return _internal_local_fill_source_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::_internal_mutable_local_fill_source_ids() {
  return &_impl_.local_fill_source_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
DegradedReadRequest::mutable_local_fill_source_ids() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.DegradedReadRequest.local_fill_source_ids)
  return _internal_mutable_local_fill_source_ids();
}

// bool send_raw_union = 17;
inline void DegradedReadRequest::clear_send_raw_union() {
  _impl_.send_raw_union_ = false;
}
inline bool DegradedReadRequest::_internal_send_raw_union() const {
  return _impl_.send_raw_union_;
}
inline bool DegradedReadRequest::send_raw_union() const {
  // @@protoc_insertion_point(field_get:proxy_proto.DegradedReadRequest.send_raw_union)
  return _internal_send_raw_union();
}
inline void DegradedReadRequest::_internal_set_send_raw_union(bool value) {
  
  _impl_.send_raw_union_ = value;
}
inline void DegradedReadRequest::set_send_raw_union(bool value) {
  _internal_set_send_raw_union(value);
  // @@protoc_insertion_point(field_set:proxy_proto.DegradedReadRequest.send_raw_union)
}
...
// repeated int32 decode_block_ids = 14;
inline int RecoveryRequest::_internal_decode_block_ids_size() const {
  return _impl_.decode_block_ids_.size();
}
inline int RecoveryRequest::decode_block_ids_size() const {
  return _internal_decode_block_ids_size();
}
inline void RecoveryRequest::clear_decode_block_ids() {
  _impl_.decode_block_ids_.Clear();
}
inline int32_t RecoveryRequest::_internal_decode_block_ids(int index) const {
  return _impl_.decode_block_ids_.Get(index);
}
inline int32_t RecoveryRequest::decode_block_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.RecoveryRequest.decode_block_ids)
  return _internal_decode_block_ids(index);
}
inline void RecoveryRequest::set_decode_block_ids(int index, int32_t value) {
  _impl_.decode_block_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.decode_block_ids)
}
inline void RecoveryRequest::_internal_add_decode_block_ids(int32_t value) {
  _impl_.decode_block_ids_.Add(value);
}
inline void RecoveryRequest::add_decode_block_ids(int32_t value) {
  _internal_add_decode_block_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.decode_block_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::_internal_decode_block_ids() const {
  return _impl_.decode_block_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::decode_block_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.RecoveryRequest.decode_block_ids)
  return _internal_decode_block_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
RecoveryRequest::_internal_mutable_decode_block_ids() {
  return &_impl_.decode_block_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
RecoveryRequest::mutable_decode_block_ids() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.RecoveryRequest.decode_block_ids)
  return _internal_mutable_decode_block_ids();
}
...
// repeated int32 all_failed_block_ids = 19;
inline int RecoveryRequest::_internal_all_failed_block_ids_size() const {
  return _impl_.all_failed_block_ids_.size();
}
inline int RecoveryRequest::all_failed_block_ids_size() const {
  return _internal_all_failed_block_ids_size();
}
inline void RecoveryRequest::clear_all_failed_block_ids() {
  _impl_.all_failed_block_ids_.Clear();
}
inline int32_t RecoveryRequest::_internal_all_failed_block_ids(int index) const {
  return _impl_.all_failed_block_ids_.Get(index);
}
inline int32_t RecoveryRequest::all_failed_block_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.RecoveryRequest.all_failed_block_ids)
  return _internal_all_failed_block_ids(index);
}
inline void RecoveryRequest::set_all_failed_block_ids(int index, int32_t value) {
  _impl_.all_failed_block_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.all_failed_block_ids)
}
inline void RecoveryRequest::_internal_add_all_failed_block_ids(int32_t value) {
  _impl_.all_failed_block_ids_.Add(value);
}
inline void RecoveryRequest::add_all_failed_block_ids(int32_t value) {
  _internal_add_all_failed_block_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.all_failed_block_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::_internal_all_failed_block_ids() const {
  return _impl_.all_failed_block_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::all_failed_block_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.RecoveryRequest.all_failed_block_ids)
  return _internal_all_failed_block_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
RecoveryRequest::_internal_mutable_all_failed_block_ids() {
  return &_impl_.all_failed_block_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
...
// repeated int32 local_fill_source_ids = 29;
inline int RecoveryRequest::_internal_local_fill_source_ids_size() const {
  return _impl_.local_fill_source_ids_.size();
}
inline int RecoveryRequest::local_fill_source_ids_size() const {
  return _internal_local_fill_source_ids_size();
}
inline void RecoveryRequest::clear_local_fill_source_ids() {
  _impl_.local_fill_source_ids_.Clear();
}
inline int32_t RecoveryRequest::_internal_local_fill_source_ids(int index) const {
  return _impl_.local_fill_source_ids_.Get(index);
}
inline int32_t RecoveryRequest::local_fill_source_ids(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.RecoveryRequest.local_fill_source_ids)
  return _internal_local_fill_source_ids(index);
}
inline void RecoveryRequest::set_local_fill_source_ids(int index, int32_t value) {
  _impl_.local_fill_source_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.local_fill_source_ids)
}
inline void RecoveryRequest::_internal_add_local_fill_source_ids(int32_t value) {
  _impl_.local_fill_source_ids_.Add(value);
}
inline void RecoveryRequest::add_local_fill_source_ids(int32_t value) {
  _internal_add_local_fill_source_ids(value);
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.local_fill_source_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::_internal_local_fill_source_ids() const {
  return _impl_.local_fill_source_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::local_fill_source_ids() const {
  // @@protoc_insertion_point(field_list:proxy_proto.RecoveryRequest.local_fill_source_ids)
  return _internal_local_fill_source_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
RecoveryRequest::_internal_mutable_local_fill_source_ids() {
  return &_impl_.local_fill_source_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
RecoveryRequest::mutable_local_fill_source_ids() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.RecoveryRequest.local_fill_source_ids)
  return _internal_mutable_local_fill_source_ids();
}

// repeated string leftover_block_keys = 30;
inline int RecoveryRequest::_internal_leftover_block_keys_size() const {
  return _impl_.leftover_block_keys_.size();
}
inline int RecoveryRequest::leftover_block_keys_size() const {
  return _internal_leftover_block_keys_size();
}
inline void RecoveryRequest::clear_leftover_block_keys() {
  _impl_.leftover_block_keys_.Clear();
}
inline std::string* RecoveryRequest::add_leftover_block_keys() {
  std::string* _s = _internal_add_leftover_block_keys();
  // @@protoc_insertion_point(field_add_mutable:proxy_proto.RecoveryRequest.leftover_block_keys)
  return _s;
}
inline const std::string& RecoveryRequest::_internal_leftover_block_keys(int index) const {
  return _impl_.leftover_block_keys_.Get(index);
}
inline const std::string& RecoveryRequest::leftover_block_keys(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.RecoveryRequest.leftover_block_keys)
  return _internal_leftover_block_keys(index);
}
inline std::string* RecoveryRequest::mutable_leftover_block_keys(int index) {
  // @@protoc_insertion_point(field_mutable:proxy_proto.RecoveryRequest.leftover_block_keys)
  return _impl_.leftover_block_keys_.Mutable(index);
}
inline void RecoveryRequest::set_leftover_block_keys(int index, const std::string& value) {
  _impl_.leftover_block_keys_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline void RecoveryRequest::set_leftover_block_keys(int index, std::string&& value) {
  _impl_.leftover_block_keys_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline void RecoveryRequest::set_leftover_block_keys(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.leftover_block_keys_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline void RecoveryRequest::set_leftover_block_keys(int index, const char* value, size_t size) {
  _impl_.leftover_block_keys_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline std::string* RecoveryRequest::_internal_add_leftover_block_keys() {
  return _impl_.leftover_block_keys_.Add();
}
inline void RecoveryRequest::add_leftover_block_keys(const std::string& value) {
  _impl_.leftover_block_keys_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline void RecoveryRequest::add_leftover_block_keys(std::string&& value) {
  _impl_.leftover_block_keys_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline void RecoveryRequest::add_leftover_block_keys(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.leftover_block_keys_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline void RecoveryRequest::add_leftover_block_keys(const char* value, size_t size) {
  _impl_.leftover_block_keys_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:proxy_proto.RecoveryRequest.leftover_block_keys)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
RecoveryRequest::leftover_block_keys() const {
  // @@protoc_insertion_point(field_list:proxy_proto.RecoveryRequest.leftover_block_keys)
  return _impl_.leftover_block_keys_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
RecoveryRequest::mutable_leftover_block_keys() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.RecoveryRequest.leftover_block_keys)
  return &_impl_.leftover_block_keys_;
}

// repeated string leftover_replaced_node_ips = 31;
inline int RecoveryRequest::_internal_leftover_replaced_node_ips_size() const {
  return _impl_.leftover_replaced_node_ips_.size();
}
inline int RecoveryRequest::leftover_replaced_node_ips_size() const {
  return _internal_leftover_replaced_node_ips_size();
}
inline void RecoveryRequest::clear_leftover_replaced_node_ips() {
  _impl_.leftover_replaced_node_ips_.Clear();
}
inline std::string* RecoveryRequest::add_leftover_replaced_node_ips() {
  std::string* _s = _internal_add_leftover_replaced_node_ips();
  // @@protoc_insertion_point(field_add_mutable:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
  return _s;
}
inline const std::string& RecoveryRequest::_internal_leftover_replaced_node_ips(int index) const {
  return _impl_.leftover_replaced_node_ips_.Get(index);
}
inline const std::string& RecoveryRequest::leftover_replaced_node_ips(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
  return _internal_leftover_replaced_node_ips(index);
}
inline std::string* RecoveryRequest::mutable_leftover_replaced_node_ips(int index) {
  // @@protoc_insertion_point(field_mutable:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
  return _impl_.leftover_replaced_node_ips_.Mutable(index);
}
inline void RecoveryRequest::set_leftover_replaced_node_ips(int index, const std::string& value) {
  _impl_.leftover_replaced_node_ips_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline void RecoveryRequest::set_leftover_replaced_node_ips(int index, std::string&& value) {
  _impl_.leftover_replaced_node_ips_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline void RecoveryRequest::set_leftover_replaced_node_ips(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.leftover_replaced_node_ips_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline void RecoveryRequest::set_leftover_replaced_node_ips(int index, const char* value, size_t size) {
  _impl_.leftover_replaced_node_ips_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline std::string* RecoveryRequest::_internal_add_leftover_replaced_node_ips() {
  return _impl_.leftover_replaced_node_ips_.Add();
}
inline void RecoveryRequest::add_leftover_replaced_node_ips(const std::string& value) {
  _impl_.leftover_replaced_node_ips_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline void RecoveryRequest::add_leftover_replaced_node_ips(std::string&& value) {
  _impl_.leftover_replaced_node_ips_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline void RecoveryRequest::add_leftover_replaced_node_ips(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.leftover_replaced_node_ips_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline void RecoveryRequest::add_leftover_replaced_node_ips(const char* value, size_t size) {
  _impl_.leftover_replaced_node_ips_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
RecoveryRequest::leftover_replaced_node_ips() const {
  // @@protoc_insertion_point(field_list:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
  return _impl_.leftover_replaced_node_ips_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
RecoveryRequest::mutable_leftover_replaced_node_ips() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.RecoveryRequest.leftover_replaced_node_ips)
  return &_impl_.leftover_replaced_node_ips_;
}

// repeated int32 leftover_replaced_node_ports = 32;
inline int RecoveryRequest::_internal_leftover_replaced_node_ports_size() const {
  return _impl_.leftover_replaced_node_ports_.size();
}
inline int RecoveryRequest::leftover_replaced_node_ports_size() const {
  return _internal_leftover_replaced_node_ports_size();
}
inline void RecoveryRequest::clear_leftover_replaced_node_ports() {
  _impl_.leftover_replaced_node_ports_.Clear();
}
inline int32_t RecoveryRequest::_internal_leftover_replaced_node_ports(int index) const {
  return _impl_.leftover_replaced_node_ports_.Get(index);
}
inline int32_t RecoveryRequest::leftover_replaced_node_ports(int index) const {
  // @@protoc_insertion_point(field_get:proxy_proto.RecoveryRequest.leftover_replaced_node_ports)
  return _internal_leftover_replaced_node_ports(index);
}
inline void RecoveryRequest::set_leftover_replaced_node_ports(int index, int32_t value) {
  _impl_.leftover_replaced_node_ports_.Set(index, value);
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.leftover_replaced_node_ports)
}
inline void RecoveryRequest::_internal_add_leftover_replaced_node_ports(int32_t value) {
  _impl_.leftover_replaced_node_ports_.Add(value);
}
inline void RecoveryRequest::add_leftover_replaced_node_ports(int32_t value) {
  _internal_add_leftover_replaced_node_ports(value);
  // @@protoc_insertion_point(field_add:proxy_proto.RecoveryRequest.leftover_replaced_node_ports)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::_internal_leftover_replaced_node_ports() const {
  return _impl_.leftover_replaced_node_ports_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
RecoveryRequest::leftover_replaced_node_ports() const {
  // @@protoc_insertion_point(field_list:proxy_proto.RecoveryRequest.leftover_replaced_node_ports)
  return _internal_leftover_replaced_node_ports();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
RecoveryRequest::_internal_mutable_leftover_replaced_node_ports() {
  return &_impl_.leftover_replaced_node_ports_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
RecoveryRequest::mutable_leftover_replaced_node_ports() {
  // @@protoc_insertion_point(field_mutable_list:proxy_proto.RecoveryRequest.leftover_replaced_node_ports)
  return _internal_mutable_leftover_replaced_node_ports();
}

// int32 raw_sender_num = 33;
inline void RecoveryRequest::clear_raw_sender_num() {
  _impl_.raw_sender_num_ = 0;
}
inline int32_t RecoveryRequest::_internal_raw_sender_num() const {
  return _impl_.raw_sender_num_;
}
inline int32_t RecoveryRequest::raw_sender_num() const {
  // @@protoc_insertion_point(field_get:proxy_proto.RecoveryRequest.raw_sender_num)
  return _internal_raw_sender_num();
}
inline void RecoveryRequest::_internal_set_raw_sender_num(int32_t value) {
  
  _impl_.raw_sender_num_ = value;
}
inline void RecoveryRequest::set_raw_sender_num(int32_t value) {
  _internal_set_raw_sender_num(value);
  // @@protoc_insertion_point(field_set:proxy_proto.RecoveryRequest.raw_sender_num)
}
