 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    // LotusLRC unified single-rack repair: reconstruct the global batch (block_ids minus
    // recovery_block_ids leftover) AND local-fill the leftover in ONE round at the dest, with
    // per-helper raw/min transfer, then write every reconstructed block back to disk.
    // block_ids = all failed blocks on the rack; recovery_block_ids = the global-batch subset.
    virtual ::grpc::Status twoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::coordinator_proto::RecoveryReply* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::coordinator_proto::RecoveryReply>> AsynctwoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::coordinator_proto::RecoveryReply>>(AsynctwoPhaseRepairRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::coordinator_proto::RecoveryReply>> PrepareAsynctwoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::coordinator_proto::RecoveryReply>>(PrepareAsynctwoPhaseRepairRaw(context, request, cq));
    }
    ...
    class async_interface {
     public:
      ...
      // per-helper raw/min transfer, then write every reconstructed block back to disk.
      // block_ids = all failed blocks on the rack; recovery_block_ids = the global-batch subset.
      virtual void twoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* request, ::coordinator_proto::RecoveryReply* response, std::function<void(::grpc::Status)>) = 0;
      virtual void twoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* request, ::coordinator_proto::RecoveryReply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // maintenance-robust normal read: reconstruct the failed rack's data blocks in memory
      // (no disk write-back) using the single-rack N-1/N-2 split, then stream the full stripe's
      // data blocks back to the client.
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::coordinator_proto::RecoveryReply>* AsynctwoPhaseRepairRaw(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::coordinator_proto::RecoveryReply>* PrepareAsynctwoPhaseRepairRaw(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status twoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::coordinator_proto::RecoveryReply* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::coordinator_proto::RecoveryReply>> AsynctwoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::coordinator_proto::RecoveryReply>>(AsynctwoPhaseRepairRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::coordinator_proto::RecoveryReply>> PrepareAsynctwoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::coordinator_proto::RecoveryReply>>(PrepareAsynctwoPhaseRepairRaw(context, request, cq));
    }
    ...
    class async final :
     ...
     public:
      ...
      void twoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* request, ::coordinator_proto::RecoveryReply* response, std::function<void(::grpc::Status)>) override;
      void twoPhaseRepair(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* request, ::coordinator_proto::RecoveryReply* response, ::grpc::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::coordinator_proto::RecoveryReply>* AsynctwoPhaseRepairRaw(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::coordinator_proto::RecoveryReply>* PrepareAsynctwoPhaseRepairRaw(::grpc::ClientContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_twoPhaseRepair_;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // per-helper raw/min transfer, then write every reconstructed block back to disk.
    // block_ids = all failed blocks on the rack; recovery_block_ids = the global-batch subset.
    virtual ::grpc::Status twoPhaseRepair(::grpc::ServerContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* request, ::coordinator_proto::RecoveryReply* response);
    // maintenance-robust normal read: reconstruct the failed rack's data blocks in memory
    // (no disk write-back) using the single-rack N-1/N-2 split, then stream the full stripe's
    // data blocks back to the client.
  ...
  template <class BaseClass>
  class WithAsyncMethod_twoPhaseRepair : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_twoPhaseRepair() {
      ::grpc::Service::MarkMethodAsync(21);
    }
    ~WithAsyncMethod_twoPhaseRepair() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status twoPhaseRepair(::grpc::ServerContext* /*context*/, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* /*request*/, ::coordinator_proto::RecoveryReply* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequesttwoPhaseRepair(::grpc::ServerContext* context, ::coordinator_proto::StripeIdAndBlockIDsFromClient* request, ::grpc::ServerAsyncResponseWriter< ::coordinator_proto::RecoveryReply>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  template <class BaseClass>
  class WithCallbackMethod_twoPhaseRepair : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_twoPhaseRepair() {
      ::grpc::Service::MarkMethodCallback(21,
          new ::grpc::internal::CallbackUnaryHandler< ::coordinator_proto::StripeIdAndBlockIDsFromClient, ::coordinator_proto::RecoveryReply>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* request, ::coordinator_proto::RecoveryReply* response) { return this->twoPhaseRepair(context, request, response); }));}
    void SetMessageAllocatorFor_twoPhaseRepair(
        ::grpc::MessageAllocator< ::coordinator_proto::StripeIdAndBlockIDsFromClient, ::coordinator_proto::RecoveryReply>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(21);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::coordinator_proto::StripeIdAndBlockIDsFromClient, ::coordinator_proto::RecoveryReply>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_twoPhaseRepair() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status twoPhaseRepair(::grpc::ServerContext* /*context*/, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* /*request*/, ::coordinator_proto::RecoveryReply* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* twoPhaseRepair(
      ::grpc::CallbackServerContext* /*context*/, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* /*request*/, ::coordinator_proto::RecoveryReply* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithGenericMethod_twoPhaseRepair : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_twoPhaseRepair() {
      ::grpc::Service::MarkMethodGeneric(21);
    }
    ~WithGenericMethod_twoPhaseRepair() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status twoPhaseRepair(::grpc::ServerContext* /*context*/, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* /*request*/, ::coordinator_proto::RecoveryReply* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_twoPhaseRepair : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_twoPhaseRepair() {
      ::grpc::Service::MarkMethodRaw(21);
    }
    ~WithRawMethod_twoPhaseRepair() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status twoPhaseRepair(::grpc::ServerContext* /*context*/, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* /*request*/, ::coordinator_proto::RecoveryReply* /*response*/) override {
    ...
    void RequesttwoPhaseRepair(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(21, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_twoPhaseRepair : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_twoPhaseRepair() {
      ::grpc::Service::MarkMethodRawCallback(21,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->twoPhaseRepair(context, request, response); }));
    }
    ~WithRawCallbackMethod_twoPhaseRepair() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status twoPhaseRepair(::grpc::ServerContext* /*context*/, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* /*request*/, ::coordinator_proto::RecoveryReply* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_twoPhaseRepair : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_twoPhaseRepair() {
        ...
        new ::grpc::internal::StreamedUnaryHandler<
          ::coordinator_proto::StripeIdAndBlockIDsFromClient, ::coordinator_proto::RecoveryReply>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::coordinator_proto::StripeIdAndBlockIDsFromClient, ::coordinator_proto::RecoveryReply>* streamer) {
                       return this->StreamedtwoPhaseRepair(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_twoPhaseRepair() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status twoPhaseRepair(::grpc::ServerContext* /*context*/, const ::coordinator_proto::StripeIdAndBlockIDsFromClient* /*request*/, ::coordinator_proto::RecoveryReply* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedtwoPhaseRepair(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::coordinator_proto::StripeIdAndBlockIDsFromClient,::coordinator_proto::RecoveryReply>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
